...
import com.sanmed.android.balance.view.add_category_expense.IAddCategoryExpenseView
    ...
    companion object{
        fun <T : IAddCategoryExpenseView> showCategoryExpenseDialog(dialogHandler: IDialogHandler<T>,  lifecycleOwner: LifecycleOwner){
            if(dialogHandler.getDialog() == null){
                ...
                val binding: ViewAddCategoryExpenseBinding = DataBindingUtil.inflate(inflater,
