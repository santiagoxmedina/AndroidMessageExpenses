...
@HiltViewModel
class SummaryViewModel @Inject constructor(private val _expensesRepository:IExpensesRepository): ViewModel(), ISummaryViewModel {

    private val _navigateToExpenses = MutableLiveData<Boolean>()
    val navigateToExpenses : LiveData<Boolean> get() = _navigateToExpenses
    val items : LiveData<List<SummaryItemView>> get() = _expensesRepository.getSummaryExpenses()
    ...
    override fun getSummaryItemList(): LiveData<List<SummaryItemView>> {
        return items
    }
